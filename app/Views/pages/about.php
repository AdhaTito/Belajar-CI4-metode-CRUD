...
<body background=" ../images/bg3.svg">
    ...
    <div class="container">
        <main>
            ...
            <div class="container px-4 py-5" id="featured-3">
                <h2 class="pb-2 border-bottom border-dark border-3">Columns with icons</h2>
            ...
            <div class="container px-4 py-5" id="custom-cards">
                <h2 class="pb-2 border-bottom border-dark border-3">Custom cards</h2>
